...
const GameButton = ({game, hidden, children}) => {
    return (
        <a className={ `transition ease-in-out flex flex-col items-center text-zinc-300 hover:text-zinc-100 ${hidden ? "opacity-0 pointer-events-none" : ""}`} href={ `${ window.location.protocol }//${ game.toLowerCase() }.quibbble.com` } target="_blank" rel="noreferrer">
            <div className={`bg-zinc-900 rounded-md flex items-center justify-center mb-1 p-4 overflow-hidden`}>
            ...
            <div className="w-full max-w-2xl flex flex-col items-center">
                ...
                <div className="mt-12 fade-in w-72 flex flex-col items-center">
                    <div className="flex gap-2 md:gap-4 self-center mb-6">
                        ...
                        <GameButton game="Connect4">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100">
                                <circle className="fill-yellow-400" cx="11.96" cy="11.96" r="11.96"/>
                                <circle className="fill-yellow-400" cx="37.32" cy="37.32" r="11.96"/>
                                <circle className="fill-yellow-400" cx="62.68" cy="62.69" r="11.96"/>
                                <circle className="fill-yellow-400" cx="88.05" cy="88.05" r="11.96"/>                                   
                            </svg>
                        </GameButton>
                        <GameButton game="Stratego">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100">
