            ...
            <div className="w-full max-w-2xl flex flex-col items-center">
                ...
                <div className="mt-12 fade-in w-72 flex flex-col items-center">
                    <div className="flex gap-2 md:gap-4 self-center mb-6">
                        <GameButton game="Tsuro" color="red-500">
                        ...
                        <GameButton game="Carcassonne" color="orange-500">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100">
                        ...
                        <GameButton game="Connect4" color="yellow-300">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100">
                        ...
                        <GameButton game="Stratego" color="blue-500">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100">
                    ...
                    <div className="flex gap-2 md:gap-4 self-center mb-6">
                        <GameButton game="Indigo" color="indigo-500">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100"> 
                        ...
                        <GameButton game="TicTacToe" color="green-600">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100">
